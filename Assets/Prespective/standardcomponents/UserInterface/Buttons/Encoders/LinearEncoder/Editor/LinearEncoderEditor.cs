...
{
    public class LinearEncoderEditor : PrespectiveEditor, IControlPanel
    {
#pragma warning disable 0618

        private LinearEncoder component;
        ...
        {
            component = (LinearEncoder)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (toolbarTab.intValue)
            {
                ...
                case 1:
                    ...
                    component.ValuePerWholeCycle = EditorGUILayout.DelayedFloatField("Cycle Value", component.ValuePerWholeCycle);
