...
namespace u040.prespective.standardcomponents.kinetics.motor.servomotor
{
    ...
    public class DrivenServoMotorLogic : StandardLogicComponent<DrivenServoMotor>
    {
        ...
        void onSignalChanged(SignalInstance _signal, object _newValue, DateTime _newValueReceived, object _oldValue, DateTime _oldValueReceived)
        {
            switch (_signal.definition.defaultSignalName)
            {
                case "oPreferredVelocity":
                    Target.PreferredVelocity = (float)_newValue;
                    break;

                case "oTarget":
                    Target.TargetAngle = (float)_newValue;
                    break;
                ...
                case "oDirection":
                    Target.ContinuousDirection = (bool)_newValue ? DrivenMotor.Direction.CW : DrivenMotor.Direction.CCW;
                    break;
