...
{
    public class DrivenServoMotorEditor : PrespectiveEditor, IControlPanel
    {
#pragma warning disable 0618
        ...
        public void ShowControlPanel()
        {
            ...
            component.TargetAngle = EditorGUILayout.DelayedFloatField("Target Angle (deg)", component.TargetAngle);
            component.Continuous = EditorGUILayout.Toggle("Continuous", component.Continuous);
            component.ContinuousDirection = (DrivenServoMotor.Direction)EditorGUILayout.EnumPopup("Continuous Direction", component.ContinuousDirection);
