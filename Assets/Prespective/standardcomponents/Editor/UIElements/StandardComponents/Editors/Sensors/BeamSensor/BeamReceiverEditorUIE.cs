...
namespace u040.prespective.standardcomponents.sensors.beamsensor.editor
{
    ...
    public class BeamReceiverEditorUIE : StandardComponentEditorUIE<BeamReceiver>
    {
        ...
        {
            visualTree = Resources.Load<VisualTreeAsset>("Sensors/BeamSensor/BeamReceiverLayout");
        ...
        protected override void UpdateLiveData()
        {
            ...
            outputSignal.value = component.OutputSignal.ToString();
        }
