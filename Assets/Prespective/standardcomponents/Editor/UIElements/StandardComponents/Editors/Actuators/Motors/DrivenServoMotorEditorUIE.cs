...
#pragma warning disable 0618
    ...
    public class DrivenServoMotorEditorUIE : StandardComponentEditorUIE<DrivenServoMotor>
    {
        ...
        {
            visualTree = Resources.Load<VisualTreeAsset>("Actuators/Motors/DrivenServoMotorLayout");
        ...
        public override void ShowControlPanelProperties(VisualElement _container)
        {
            ...
            (
                ...
                e =>
                {
                    component.ContinuousDirection = (DrivenServoMotor.Direction)e.newValue;
                }
            );
        ...
        protected override void UpdateControlPanelData()
        {
            ...
            {
                targetAngleControlPanel.value = component.TargetAngle;
            }
        }
