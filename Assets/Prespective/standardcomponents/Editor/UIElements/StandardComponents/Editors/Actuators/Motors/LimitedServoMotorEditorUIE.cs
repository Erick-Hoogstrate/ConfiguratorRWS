...
using u040.prespective.standardcomponents.materialhandling.gripper.editor;
...
#pragma warning disable 0618
    ...
    public class LimitedServoMotorEditorUIE : StandardComponentEditorUIE<LimitedServoMotor>
    {
        ...
        FloatField zeroDegreePulseWidth;
        FloatField oneEightyDegpulseWidth;
        FloatField deadBandWidth;
        #endregion
        ...
        {
            visualTree = Resources.Load<VisualTreeAsset>("Actuators/Motors/LimitedServoMotorLayout");
        ...
        protected override void Initialize()
        {
            ...
            damping = root.Q<FloatField>(name: "damping");
            ...
            zeroDegreePulseWidth = root.Q<FloatField>(name: "zero-degree-pulse-width");
            oneEightyDegpulseWidth = root.Q<FloatField>(name: "180-degree-pulse-width");
            deadBandWidth = root.Q<FloatField>(name: "dead-band-width");
