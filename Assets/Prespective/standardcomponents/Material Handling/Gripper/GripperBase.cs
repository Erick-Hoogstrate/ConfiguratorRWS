...
{
    public class GripperBase : MonoBehaviour
    {
...
#pragma warning disable 0414 
        ...
        /// </summary>
        [SerializeField]
        private List<FingerSetting> gripperFingers = new List<FingerSetting>();
        public List<FingerSetting> GripperFingers
        {
            get
            {
                gripperFingers.RemoveAll(_e => _e.Finger == null);
                return this.gripperFingers;
            }
            set
            {
                this.gripperFingers = value;
            }
        }
        ...
        [SerializeField] private float targetClosePercentage = 0f;
        /// <summary>
        ...
        [SerializeField] private float currentClosePercentage = 0f;
        /// <summary>
